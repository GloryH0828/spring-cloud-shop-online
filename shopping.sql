...
CREATE TABLE `activate`  (
  ...
  PRIMARY KEY (`activate_id`) USING BTREE,
  INDEX `vipp_id`(`v_id`) USING BTREE,
  CONSTRAINT `vipp_id` FOREIGN KEY (`v_id`) REFERENCES `vip` (`vip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of activate
-- ----------------------------
INSERT INTO `activate` VALUES (5, 15, 'f6e296ed13d14e9b9859dd71ada702a5', '2020-11-30 11:47:38');
INSERT INTO `activate` VALUES (6, 16, '13c66bfd38224988a45548f2bd179aa2', '2020-12-01 00:45:12');
...
CREATE TABLE `address`  (
  ...
  `total_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  CONSTRAINT `area` FOREIGN KEY (`area`) REFERENCES `areas` (`area_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `city` FOREIGN KEY (`city`) REFERENCES `cities` (`city_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `provinceid` FOREIGN KEY (`province`) REFERENCES `provinces` (`province_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `vid` FOREIGN KEY (`v_id`) REFERENCES `vip` (`vip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of address
-- ----------------------------
INSERT INTO `address` VALUES (1, '120000', '120100', '120106', '健康路', '120106', '黄光辉', '18700000000', 1);
INSERT INTO `address` VALUES (2, '410000', '410100', '410102', '中原中路41号', '475300', '黄光辉', '17624407987', 1);
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', '4297f44b13955235245b2497399d7a93', 'hgh');
...
CREATE TABLE `cart`  (
  ...
  `cart_count` int(255) NULL DEFAULT NULL,
  `v_id` int(11) NULL DEFAULT NULL,
  `total_price` float(10, 2) NULL DEFAULT NULL,
  PRIMARY KEY (`cart_id`) USING BTREE,
  INDEX `pro_id`(`p_id`) USING BTREE,
  INDEX `viper_id`(`v_id`) USING BTREE,
  CONSTRAINT `pro_id` FOREIGN KEY (`p_id`) REFERENCES `product` (`product_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `viper_id` FOREIGN KEY (`v_id`) REFERENCES `vip` (`vip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cart
-- ----------------------------
INSERT INTO `cart` VALUES (7, 9, 4, 1, 492.00);
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, '手机', 3);
INSERT INTO `category` VALUES (2, '电脑', 1);
INSERT INTO `category` VALUES (5, '上衣', 2);
INSERT INTO `category` VALUES (6, '裤子', 2);
INSERT INTO `category` VALUES (7, '耳机', 2);
INSERT INTO `category` VALUES (8, '水杯', 2);
INSERT INTO `category` VALUES (9, '帽子', 2);
INSERT INTO `category` VALUES (13, '数码设备', 2);
...
CREATE TABLE `comment`  (
  ...
  INDEX `vip_id`(`v_id`) USING BTREE,
  CONSTRAINT `p_id` FOREIGN KEY (`p_id`) REFERENCES `product` (`product_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `vip_id` FOREIGN KEY (`v_id`) REFERENCES `vip` (`vip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `express`  (
  ...
  `o_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `express_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  CONSTRAINT `o_id` FOREIGN KEY (`o_id`) REFERENCES `order` (`order_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `order`  (
  ...
  INDEX `aid`(`a_id`) USING BTREE,
  INDEX `v_id`(`v_id`) USING BTREE,
  CONSTRAINT `aid` FOREIGN KEY (`a_id`) REFERENCES `address` (`address_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `v_id` FOREIGN KEY (`v_id`) REFERENCES `vip` (`vip_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('123', '2020-11-20 12:34:56', 1, 1525.00, '五', 1, 1);
INSERT INTO `order` VALUES ('2709e19932124c3eaf312e576c606962', '2020-11-21 20:14:12', NULL, 246.00, NULL, 1, 0);
INSERT INTO `order` VALUES ('436eea3a428e4052877c23f8cffa11bc', '2020-12-24 12:33:21', 1, 6999.00, NULL, 1, 1);
INSERT INTO `order` VALUES ('80f69861f0484985a3af0efbd13c0298', '2020-12-02 08:51:16', NULL, 20997.00, NULL, 1, 0);
INSERT INTO `order` VALUES ('c3319ec2383e4b8b99aff65a863162d7', '2020-11-21 19:17:31', NULL, 1525.00, NULL, 1, 0);
INSERT INTO `order` VALUES ('d02509981e8b4f859d7cd15fca36d7f9', '2020-12-01 10:04:13', 1, 246.00, NULL, 1, 1);
...
CREATE TABLE `order_item`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `buy_count` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `buy_price` decimal(10, 2) NULL DEFAULT NULL,
  `p_id` int(11) NULL DEFAULT NULL,
  `o_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pid`(`p_id`) USING BTREE,
  INDEX `oid`(`o_id`) USING BTREE,
  CONSTRAINT `oid` FOREIGN KEY (`o_id`) REFERENCES `order` (`order_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `pid` FOREIGN KEY (`p_id`) REFERENCES `product` (`product_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of order_item
-- ----------------------------
INSERT INTO `order_item` VALUES (3, '4', 1156.00, 19, '123');
INSERT INTO `order_item` VALUES (4, '3', 369.00, 18, '123');
INSERT INTO `order_item` VALUES (7, '4', 1156.00, 19, 'c3319ec2383e4b8b99aff65a863162d7');
INSERT INTO `order_item` VALUES (8, '3', 369.00, 18, 'c3319ec2383e4b8b99aff65a863162d7');
INSERT INTO `order_item` VALUES (10, '2', 246.00, 18, '2709e19932124c3eaf312e576c606962');
INSERT INTO `order_item` VALUES (12, '2', 246.00, 18, 'd02509981e8b4f859d7cd15fca36d7f9');
INSERT INTO `order_item` VALUES (13, '3', 20997.00, 21, '80f69861f0484985a3af0efbd13c0298');
INSERT INTO `order_item` VALUES (14, '1', 6999.00, 21, '436eea3a428e4052877c23f8cffa11bc');
...
CREATE TABLE `product`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `mark_price` decimal(10, 2) NULL DEFAULT NULL,
  `price` decimal(10, 2) NULL DEFAULT NULL,
  `quantity` int(255) NULL DEFAULT NULL,
  `hit` int(255) NULL DEFAULT NULL,
  `time` date NULL DEFAULT NULL,
  `photo` int(255) NULL DEFAULT 0,
  `c_id` int(11) NULL DEFAULT NULL,
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL,
  PRIMARY KEY (`product_id`) USING BTREE,
  INDEX `cid`(`c_id`) USING BTREE,
  CONSTRAINT `cid` FOREIGN KEY (`c_id`) REFERENCES `category` (`category_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, '卫衣', 100.00, 80.00, 1000, 0, '2020-11-08', 1, 1, '<p>保暖</p>');
INSERT INTO `product` VALUES (2, '短袖', 100.00, 75.00, 2000, 200, '2020-11-08', 1, 1, '<p>该数据库的感觉</p>');
INSERT INTO `product` VALUES (9, '小米9', 2998.00, 123.00, 123, 123, '2020-11-09', 1, 1, '<p>237</p>');
INSERT INTO `product` VALUES (10, '小米10', 2999.00, 2999.00, 123, 123, '2020-11-09', 1, 1, '123');
INSERT INTO `product` VALUES (11, 'RTX3090', 9999.00, 9999.00, 123, 9, '2020-11-09', 1, 13, '大大');
INSERT INTO `product` VALUES (12, 'RTX3080', 5699.00, 5099.00, 100, 1000, '2020-11-09', 1, 13, '123123');
INSERT INTO `product` VALUES (18, '电钻', 123.00, 123.00, 123, 123, '2020-11-17', 1, 1, '<p><img alt=\"\" data-cke-saved-src=\"/images/a137194bd98042f8aead3a2e97894d0562988.jpg_80x80.jpg\" src=\"/images/a137194bd98042f8aead3a2e97894d0562988.jpg_80x80.jpg\" style=\"width: 80px; height: 80px;\">速度快的方式k 解放路口否<br></p><p>&nbsp;分局肯德基&nbsp;</p><p>5646545646556456</p>');
INSERT INTO `product` VALUES (19, '小米8', 2999.00, 289.00, 123, 1000, '2020-11-17', 1, 1, '<p><img alt=\"\" data-cke-saved-src=\"/images/323996df6635436da7af6c684a3fc4b201.jpg\" src=\"/images/323996df6635436da7af6c684a3fc4b201.jpg\" style=\"width: 800px; height: 800px;\">​​​​​​​<br></p>');
INSERT INTO `product` VALUES (20, '小米 MIX Alpha', 12999.00, 12999.00, 10, 100000, '2020-11-17', 1, 1, '<p><img alt=\"\" data-cke-saved-src=\"/images/7a26bd71153b447095d77ac1b1f4af0d111.jpg\" src=\"/images/7a26bd71153b447095d77ac1b1f4af0d111.jpg\" style=\"height:100px; width:100px\">​​​​​​​<br></p><p>公司借款的非官方萨克斯</p>');
INSERT INTO `product` VALUES (21, '小米 10 Ultra', 7099.00, 6999.00, 20, 1000, '2020-12-02', 1, 1, '<p><img alt=\"\" data-cke-saved-src=\"/images/535859251a6e481284a37eba69854458ad8.jpg\" src=\"/images/535859251a6e481284a37eba69854458ad8.jpg\" style=\"height:320px; width:760px\">​​​​​​​</p>');
INSERT INTO `product` VALUES (22, 'xiaomi', 2222.00, 289.00, 22, 22, '2020-12-25', 1, 1, '<p><img alt=\"\" data-cke-saved-src=\"/images/2442733caf494cb19961aa9f094feeeflogo2.png\" src=\"/images/2442733caf494cb19961aa9f094feeeflogo2.png\" style=\"width: 432px; height: 432px;\">​​​​​​​<br></p>');
...
CREATE TABLE `promotion`  (
  ...
  CONSTRAINT `product_id` FOREIGN KEY (`p_id`) REFERENCES `product` (`product_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- Records of vip
-- ----------------------------
INSERT INTO `vip` VALUES (1, 'zhangsan', '4297f44b13955235245b2497399d7a93', '张三', '男', '123456@163.com', NULL, '1', '我是', '张三', '2020-12-25 00:43:28', '17699992222', 1);
INSERT INTO `vip` VALUES (4, 'lisi', '4297f44b13955235245b2497399d7a93', '李四', '女', '123@qq.com', NULL, '1', '你好', '你好', '2020-11-04 12:01:55', '17600000000', 0);
INSERT INTO `vip` VALUES (15, 'zhaoliu', '4297f44b13955235245b2497399d7a93', NULL, NULL, '2453443152@qq.com', NULL, '1', NULL, NULL, NULL, NULL, 1);
INSERT INTO `vip` VALUES (16, 'huangguanghui', '4297f44b13955235245b2497399d7a93', NULL, NULL, '2453443152@qq.com', NULL, '1', NULL, NULL, NULL, NULL, 1);
