		...
		<div class="paycont">
			<div class="address">
				...
				<ul>
					...
					<li class="user-addresslist"">
						<div class="address-left" >
							<div class="user DefaultAddr">
								...
								</span> <span class="buy-phone">15877777777</span> </span>
							</div>
							<div class="default-address DefaultAddr">
								<span class="buy-line-title buy-line-title-type">收货地址：</span> <span
									...
									class="street">东湖路75号众环大厦9栋9层999</span> </span> </span>
							</div>
					...
					<!-- 地址-->
					<li class="user-addresslist" onclick="chooseaddress()">
						<div class="address-left" >
							<div class="user DefaultAddr">
		...
		<div class="am-u-md-12">
			<form class="am-form am-form-horizontal">
				...
				<div class="am-form-group">
					...
					<div class="am-form-content">
						<input id="user-email" placeholder="邮编必填" type="email">
					</div>
				</div>
